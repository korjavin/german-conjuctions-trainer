export const dom = {
    ...
    podcastError: document.getElementById('podcast-error'),
    podcastResult: document.getElementById('podcast-result'),
    podcastAudio: document.getElementById('podcast-audio'),
    podcastMeta: document.getElementById('podcast-meta'),
    podcastDownloadLink: document.getElementById('podcast-download-link'),
    podcastTranscriptSummary: document.getElementById('podcast-transcript-summary'),
    podcastPhraseList: document.getElementById('podcast-phrase-list'),
    ...
    historyControlsContainer: document.getElementById('history-controls-container'),
    ...
    historyFilterReadyCount: document.getElementById('history-filter-ready-count'),
